 ...
 * talks to the host half's `/dsh-worktree/api` route and never runs git
...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var HOVER_CSS =
      '.dsh-worktree-btn:hover:not(:disabled){background:var(--dsw-alias-fill-l3, rgba(127,127,127,.16))}' +
      '.dsh-worktree-btn.dsh-worktree-primary:hover:not(:disabled){filter:brightness(1.06)}' +
      '.dsh-worktree-btn:disabled{opacity:.55;cursor:default}' +
      '.dsh-worktree-input:focus{border-color:var(--dsw-alias-brand-primary, #4176e6)}' +
      '.dsh-worktree-item:first-child{border-top:0 none transparent}' +
      '.dsh-worktree-link:hover{text-decoration:underline}';
    ...
    function Button(props) {
      ...
      return React.createElement(
        ...
        {
          type: 'button',
          className: 'dsh-worktree-btn' + (props.variant === 'primary' ? ' dsh-worktree-primary' : ''),
    ...
    function WorktreeRow(props) {
      ...
      return React.createElement(
        'div',
        { className: 'dsh-worktree-item', style: S.item },
        React.createElement(
          'div',
          { style: S.itemText },
    ...
    function apply(ctx) {
      ...
      if (typeof document !== 'undefined') {
        ctx.effect(function () {
          ...
          tag.dataset.pluginCss = 'dsh-worktree/enhance';
          tag.textContent = HOVER_CSS;
          document.head.appendChild(tag);
          return function () {
            tag.remove();
          };
        }, 'dsh-worktree: enhance stylesheet');
      }
